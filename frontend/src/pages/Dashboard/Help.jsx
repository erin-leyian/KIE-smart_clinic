...
import { BookOpen, Users, Lock, Shield, CheckCircle, Eye, Edit3, Trash2, BarChart3, HelpCircle, Send } from "lucide-react";
...
export default function Help() {
  ...
  const [supportConfirm, setSupportConfirm] = useState(false);
  ...
  const handleSendSupport = async () => {
    ...
    setSupportConfirm(true);
    setTimeout(() => {
      setSupportConfirm(false);
      setSupportMessage("");
      setSupportEmail("");
  ...
  return (
    <DashboardLayout title="Help & Support">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {expandedSection === "security" && (
                <div className="p-6 space-y-6 border-t">
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                    <h3 className="font-bold text-yellow-900 mb-2">What We Never Do</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-xl p-6">
              <h3 className="font-bold text-purple-900 mb-4">Contact Support</h3>
              <p className="text-xs text-purple-800 mb-4">
                For additional support or technical issues, contact our support team directly.
              </p>
              <button
                onClick={() => setShowSupportModal(true)}
                className="w-full bg-purple-600 hover:bg-purple-700 text-white text-xs font-medium py-2 rounded-lg transition-colors flex items-center justify-center gap-2"
              >
      ...
      <Modal
        ...
        onClose={() => !sendingSupport && setShowSupportModal(false)}
      ...
      >
        {supportConfirm ? (
          <div className="py-8 text-center">
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-2">Message Sent Successfully</h3>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows="4"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-teal-500 resize-none"
                disabled={sendingSupport}
              />
            </div>
            ...
            <div className="flex gap-2 pt-4 border-t">
              <button
                ...
                disabled={sendingSupport}
                className="flex-1 bg-teal-500 hover:bg-teal-600 disabled:bg-gray-400 text-white px-4 py-2 rounded-lg font-medium text-sm transition-colors flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                disabled={sendingSupport}
                className="flex-1 bg-gray-200 hover:bg-gray-300 disabled:bg-gray-300 text-gray-800 px-4 py-2 rounded-lg font-medium text-sm transition-colors"
              >
                Cancel
              </button>
            </div>
